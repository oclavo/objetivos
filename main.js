...
const tempoObjetivo1 = new Date("2026-09-13T00:00:00");
...
function calculaTempo(tempoObjetivo) {
    ...
    contador += '<div class="contador-digito">';
        ...
        contador += '</div>';const botoes = document.querySelectorAll(".botao");
        const textos = document.querySelectorAll(".aba-conteudo");
        for(let i=0; i<botoes.length; i++){
            botoes[i].onclick = function(){
                for(let j=0; j<botoes.length; j++){
        ...
        const contadores = document.querySelectorAll(".contador");
        const tempoObjetivo1 = new Date("2026-09-13T00:00:00");
        const tempoObjetivo2 = new Date("2028-09-13T00:00:00");
        const tempoObjetivo3 = new Date("2030-12-30T00:00:00");
        const tempoObjetivo4 = new Date("2040-02-05T00:00:00");
